...
This contains architecture artifacts aligned to the eAppraisalcase study: use cases, functional specs, C4 views, layered & component diagrams, cross-cutting concerns, security, NFRs, ER model, and test planning skeletons.
